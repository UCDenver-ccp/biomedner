...
public class GMCoveredRateFeatureBuilder implements NormalizationPairFeatureBuilder {
	...
	{
		if(vector_1==null || vector_2==null) return 0.0;
		if(vector_1.isEmpty() || vector_2.isEmpty()) return 0.0;
		double score = 0.0;
		double normal = 0.0;
		for(String str : vector_1)
		{
			...
			normal += idf;
			if(isContained(str, vector_2)) score += idf;
		}
	...
	{
		if(str.equals("1"))
		{//When the str is 1, if the other name has no digital, return true.
