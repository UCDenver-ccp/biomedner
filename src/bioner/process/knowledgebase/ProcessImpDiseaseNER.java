...
public class ProcessImpDiseaseNER implements BioNERProcess {

	private BioNERDictionary m_diseaseDict = KnowledgeBaseDictBuilder.getDiseaseDictionary();
	private SentenceNER m_sentencNER = SentenceNERProcessFactory.createSentenceNER(m_diseaseDict);
	@Override
